...
public class Constants {
    ...
    public static final String TAG = "Sabber";
    ...
    public static final String APIKEY_SEARCH_PREF = "apikeySearchPref";
    public static final String SEARCH_PROVIDER_PREF = "searchProviderPref";
